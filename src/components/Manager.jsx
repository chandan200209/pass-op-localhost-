            ...
            <div className='flex flex-col text-black p-5 gap-3 '>
                ...
                <div className='w-full flex flex-col gap-3 text-sm items-center'>
                    ...
                    <div className='flex-col md:flex-row flex md:gap-8 gap-3 items-center md:justify-center w-full'>
                        <div><input id='username' value={form.username} name="username" onChange={handleChange} type='text' placeholder='Enter Username' className='border-1 bg-white border-black w-[258px] md:w-[324px] lg:w-[424px] rounded-2xl px-4 py-1 text-black font-bold'></input></div>
                        <div className='relative'><input ref={passwordRef} name="password" id='password' value={form.password} onChange={handleChange} type='password' placeholder='Enter Password' className='border-1 bg-white border-black lg:w-[424px] w-[258px] md:w-[324px] rounded-2xl px-4 py-1 text-black font-bold'></input>
                            ...
                            {passwordArray.map((item, index) => {
                                return <tr key={index} className=''>
                                    ...
                                    <td className='md:min-w-25 w-10 text-xs sm:text-md md:text-[16px] sm:min-w-15 py-1 border border-white text-center '>
                                        <div className='justify-center items-center flex gap-2'>
                                            <a href=
                                                {item.password} className='cursor-pointer hidden sm:block' target='_blank'>{item.password}</a>
